...
public class Lua_ItemSO : LuaObject {
	...
	static public int get_itemImage(IntPtr l) {
		try {
			...
			#endif
			#endif
			ItemSO self=(ItemSO)checkSelf(l);
			pushValue(l,true);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_itemDescription(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			ItemSO self=(ItemSO)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.itemDescription);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_itemDescription(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"itemDescription",get_itemDescription,set_itemDescription,true);
		createTypeMetatable(l,constructor, typeof(ItemSO),typeof(UnityEngine.ScriptableObject));
	}
}
